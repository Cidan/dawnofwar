...
const   struct  cmd_type        cmd_table       [] =
{
 ...
 /*command table modified by Aeria*/
    ...
    { "down",           do_down,        POS_STANDING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS },
/*
    { "map",           do_mapp,        POS_STANDING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS },
*/
    { "nofollow",           do_nofollow,        POS_STANDING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS },
    { "noefollow",           do_noefollow,        POS_STANDING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS },
    ...
    { "get",            do_get,         POS_RESTING,     0,  LOG_NORMAL,
     C_TYPE_OBJECT, C_SHOW_ALWAYS},
    { "levelup",           do_levelup,        POS_STANDING,    1,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS },
    { "gain",           do_gain,        POS_STANDING,    1,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS },
    ...
    { "sleep",          do_sleep,       POS_SLEEPING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS},
    { "sit",          do_sit,       POS_STANDING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS},
	...
	{ "strategy",       do_strategy,    POS_FIGHTING,    0,  LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_ALWAYS},
...
*/
    ...
    { "prompt",         do_prompt,      POS_DEAD,        0,  LOG_ALWAYS,
     C_TYPE_CONFIG, C_SHOW_ALWAYS},
    { "togmap",         do_togmap,        POS_DEAD,        0,  LOG_ALWAYS,
     C_TYPE_CONFIG, C_SHOW_ALWAYS},
...
*/
    ...
    { "bash",           do_bash,        POS_FIGHTING,    0,  LOG_NORMAL,
      C_TYPE_ACTION, C_SHOW_SKILL },
    { "lodge",          do_lodge,       POS_FIGHTING,    0,  LOG_NORMAL,
      C_TYPE_ACTION, C_SHOW_SKILL },
    { "twist",          do_twist,       POS_FIGHTING,    0,  LOG_NORMAL,
      C_TYPE_ACTION, C_SHOW_SKILL },
    { "dislodge",    do_dislodge,       POS_FIGHTING,    0,  LOG_NORMAL,
      C_TYPE_ACTION, C_SHOW_SKILL },
	...
	{ "addclan",  do_addclan, POS_DEAD,            109,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
	{ "setclan",  do_setclan, POS_DEAD,           109,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
	{ "showclan",  do_showclan, POS_DEAD,           1,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
	{ "delclan",  do_delclan, POS_DEAD,           109,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "bonus",    do_bonus,       POS_DEAD,        105,      LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "alink",    do_alink,       POS_DEAD,        107,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "build",    do_build,       POS_STANDING,    2,       LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "cdebug",   do_cdebug,      POS_STANDING,    1,       LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "mpcr",     do_mpcr,        POS_STANDING,    L_DEI,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "mpstat",   do_mpstat,      POS_DEAD,        109,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "halls",    do_halls,       POS_RESTING,     L_HER,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS }, 
    { "lhunt",		do_lhunt,	POS_DEAD,	L_SUP,	LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "fhunt",		do_fhunt,	POS_DEAD,	109,	LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "sstat",		do_sstat,	POS_DEAD,	L_SUP,	LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "cset",		do_cset,	POS_DEAD,	109,	LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "clutchinfo",     do_clutchinfo,  POS_DEAD,    L_HER,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "advance",        do_advance,     POS_DEAD,    108,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "doggy",          do_dog,         POS_DEAD,    L_GOD,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "togbuild",       do_togbuild,    POS_DEAD,    109,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "togleader",      do_togleader,   POS_DEAD,    108,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "isnoop",         do_isnoop,      POS_DEAD,    L_GOD,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "trust",          do_trust,       POS_DEAD,    109,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "deathmatc",      do_deathmatc,   POS_DEAD,    108,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "deathmatch",     do_deathmatch,  POS_DEAD,    108,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "resetpasswd",  do_resetpassword,POS_DEAD,   108,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "fights",         do_fights,      POS_DEAD,    L_DEI,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "allow",          do_allow,       POS_DEAD,    108,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "iban",            do_ban,         POS_DEAD,   L_GOD,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "deny",           do_deny,        POS_DEAD,    108,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "freeze",         do_freeze,      POS_DEAD,    104,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "reboo",          do_reboo,       POS_DEAD,    109,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "reboot",         do_reboot,      POS_DEAD,    109,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "hotreboo",       do_hotreboo,    POS_DEAD,    110,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "hotreboot",  do_hotreboot,    POS_DEAD,       110,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "shutdow",        do_shutdow,     POS_DEAD,    109,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "shutdown",       do_shutdown,    POS_DEAD,    109,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "users",          do_users,       POS_DEAD,    105,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "wizify",         do_wizify,      POS_DEAD,    107,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "wizlock",        do_wizlock,     POS_DEAD,    107,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "imtlset",        do_imtlset,     POS_DEAD,    109,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "for",            do_for,         POS_DEAD,    109,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "force",          do_force,       POS_DEAD,    L_DEI,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "log",            do_log,         POS_DEAD,    109,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "mload",          do_mload,       POS_DEAD,    L_HER,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "monitor",        do_monitor,     POS_DEAD,    L_HER,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "areasave",        do_areasave,     POS_DEAD,    109,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
	{ "savearea",        do_savearea,   POS_DEAD,       106,  LOG_NORMAL,
	C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "pardon",         do_pardon,      POS_DEAD,    L_DEI,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "peace",          do_peace,       POS_DEAD,    102,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "restore",        do_restore,     POS_DEAD,    L_DEI,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "rset",           do_rset,        POS_DEAD,       109,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "silence",        do_silence,     POS_DEAD,    L_DEI,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "sla",            do_sla,         POS_DEAD,       104,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "slay",           do_slay,        POS_DEAD,    L_HER,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "snoop",          do_snoop,       POS_DEAD,    105,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "sset",           do_sset,        POS_DEAD,       107,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "transfer",       do_transfer,    POS_DEAD,    103,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "transdm",         do_transdm,    POS_DEAD,    107,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "bamfout",        do_bamfout,     POS_DEAD,    L_ANG,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "echo",           do_echo,        POS_DEAD,    103,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "goto",           do_goto,        POS_DEAD,    103,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "rstat",          do_rstat,       POS_DEAD,    L_HER,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "slookup",        do_slookup,     POS_DEAD,    107,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "switch",         do_switch,      POS_DEAD,    L_DEI,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "immtalk",        do_immtalk,     POS_DEAD,    102,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { ":",              do_immtalk,     POS_DEAD,    L_HER,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "reward",         do_reward,      POS_DEAD,    L_DEI,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "setcouncil", do_togcouncil,  POS_DEAD,    108,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS }, 
    { "resetgain",      do_gain_stat_reset, POS_DEAD, 108, LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "exlist",         do_exlist,      POS_DEAD,    108,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "vlist",          do_vlist,       POS_DEAD,    108,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "pdelete",  do_sdelete,     POS_DEAD,    2,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "scheck",   do_scheck,  POS_DEAD,    108,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    ...
    { "findreset",          do_findreset,      POS_DEAD,       L_HER,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "nuke",           do_nuke,        POS_DEAD,      108,     LOG_ALWAYS, 
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "hsight",           do_hsight,        POS_DEAD,      108,     LOG_ALWAYS, 
      C_TYPE_IMM, C_SHOW_ALWAYS},
...
void interpret( CHAR_DATA *ch, char *argument )
{
    ...
    {
        send_to_char( "{C{fYou're totally frozen!{x\n\r", ch );
	return;
    }

    if ( ch->stunTimer > 0 )
    {
      send_to_char( "You are too{CSTUNNED{x to act!\n\r", ch );
      return;
    }
    ...
    if (!IS_NPC( ch ) && (!alias_call) )
    {
	  ...
	  if ( !str_cmp( ch->pcdata->alias_name[cnt], command )
          && str_cmp( ch->pcdata->alias_name[cnt], "<none>") )
	  {
	     found = TRUE;
    ...
    if ( cmd_table[cmd].log == LOG_NEVER )
        strcpy( logline, "XXXXXXXX XXXXXXXX XXXXXXXX{x");
	...
	{
	case POS_DEAD:
            send_to_char( "Lie still; you are {dDEAD{x.\n\r", ch );
	    break;

	case POS_MORTAL:
	case POS_INCAP:
            send_to_char( "You are {rhurt{x far too bad for that.\n\r", ch );
	    break;

	case POS_STUNNED:
            send_to_char( "You are too {Rstunned{x to do that.\n\r", ch );
	    break;

	case POS_SLEEPING:
            send_to_char( "Oh, go back to {Wsleep!{x\n\r", ch );
	    break;
	...
	case POS_RESTING:
            send_to_char( "Naaaaaah... You feel too {yrelaxed{x...\n\r", ch);
	    break;

	case POS_FIGHTING:
            send_to_char( "Not until you {rstop{x fighting!\n\r", ch);
	    break;
...
bool check_social( CHAR_DATA *ch, char *command, char *argument )
{
	 ...
	 */
	    ...
	    break;
        send_to_char( "In your {Wdreams{x, or what?\n\r", ch );
	return TRUE;
