...
COOR_DATA *		first_coor = NULL;
COOR_DATA *		last_coor = NULL;
...
void (*clan_free_destructor )            ( CLAN_DATA * cdat ) = NULL;
void (*coor_free_destructor )            ( COOR_DATA * codat ) = NULL;
