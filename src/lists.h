 ...
 * -- Altrag
 */
extern	COOR_DATA *		first_coor;
extern	COOR_DATA *		last_coor;
...
extern void (*clan_free_destructor )            ( CLAN_DATA * cdat );
extern void (*coor_free_destructor )            ( COOR_DATA * codat );
