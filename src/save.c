...
void fwrite_char( CHAR_DATA *ch, FILE *fp )
{
	...
	fprintf( fp, "Train        %d\n",   ch->train               );
    fprintf( fp, "NumOfSpells  %d\n",   ch->num_of_spells       );
    fprintf( fp, "NumOfSkills  %d\n",   ch->num_of_skills       );
  ...
  fprintf( fp, "Points        %d\n", ch->pcdata->points );
  fprintf( fp, "Group         " );
      for ( cntg = 0; cntg < MAX_GROUP; cntg++)
      {
      fprintf(fp, "%i ", ch->pcdata->group[cntg]);
      }
      fprintf( fp, "\n");
  fprintf( fp, "AutoBuild    %i\n", ch->pcdata->autobuild );
  ...
  fprintf( fp, "Laston       %d\n", ch->pcdata->laston );
	...
	fprintf( fp, "AttrMax      %d %d %d %d %d %d\n",
	    ch->pcdata->max_str,
	    ch->pcdata->max_int,
	    ch->pcdata->max_wis,
	    ch->pcdata->max_dex,
	...
	fprintf( fp, "AttrLearned      %d %d %d %d %d %d\n",

	    ch->pcdata->learned_str,

	    ch->pcdata->learned_int,

	    ch->pcdata->learned_wis,

	    ch->pcdata->learned_dex,

	    ch->pcdata->learned_con,

		ch->pcdata->learned_lck );
